...
private:
    ...
    /**
     * @note ThreadSafety: Test-thread confined during fixture initialization.
     * @brief Creates one identity-swizzled color view for an RGBA8 image.
    ...
    /**
     * @note ThreadSafety: Test-thread confined during fixture initialization.
     * @brief Creates production-equivalent nearest/clamp descriptor resources.
    ...
    /**
     * @note ThreadSafety: Test-thread confined during fixture initialization.
     * @brief Creates the fullscreen pipeline from exact generated production shader bytes.
     * @return bool True when KHR entry points, modules, layout, and pipeline exist
     * @warning MemoryOwnership: Owns pipeline resources and destroys temporary modules.
     */
     ...
     * @param const std::byte* shaderBytes Aligned shader binary storage
     * @param std::size_t shaderByteCount Shader byte count divisible by four
